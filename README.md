# Kizzy Tiered Discount

Shopify public app prototype for creating studio partner discount codes that share one tiered order discount rule.

Each partner can have a different code, while all codes use the same Shopify Function:
...
Deployment notes for Render are in [docs/RENDER_DEPLOYMENT.md](docs/RENDER_DEPLOYMENT.md).
